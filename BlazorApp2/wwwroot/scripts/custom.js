function startboot() {
    ...
    $('.open-contact').click(function () {
        $('.messenger').delay(0).show(0);
        $('.back-to-top-badge').removeClass('back-to-top-badge-visible');
        setTimeout(function () {
            $('.header').addClass('move-down');
            $('.messenger').addClass('show-menu');
            $('.navigation-overlay').addClass('show-overlay');
            $('#page-content-scroll').addClass('scale-it');
        }, 10);
        return false;
    ...
    $('.navigation-overlay, .close-menu').click(function () {
        $('#page-content-scroll').removeClass('scale-it');
        $('.header').removeClass('move-down');
        $('.navigation').removeClass('show-menu');
        $('.messenger').removeClass('show-menu');
        $('.navigation-overlay').removeClass('show-overlay');
        $('.navigation').delay(350).hide(0);
        $('.messenger').delay(350).hide(0);
        return false;
    });
    ...
    $('.close-share-bottom, .share-bottom-tap-close, .navigation-overlay, .close-menu').click(function () {
        $('#page-content-scroll').removeClass('scale-it');
        $('.header').removeClass('move-down')
    ...
    if ($('body').hasClass('has-cover')) {
        ...
        function calculate_home() {
            var screen_height = $('#page-content-scroll').height();
            var screen_width = $('#page-content-scroll').width();
